...
<div id="salary_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="salaryQueryForm" method="post">
			...
			发放日期：<input type="text" id="giveDate" name="giveDate" class="easyui-datebox" editable="false" style="width:100px">
...
<div id="salaryEditDiv">
	<form id="salaryEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_year_edit" name="salary.year" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_month_edit" name="salary.month" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_giveDate_edit" name="salary.giveDate" />

			</span>

		</div>
		<div>
			<span class="label">工资备注:</span>
			<span class="inputControl">
				<textarea id="salary_salaryMemo_edit" name="salary.salaryMemo" rows="8" cols="60"></textarea>
