...
<div id="salaryAddDiv">
	<form id="salaryAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_year" name="salary.year" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_month" name="salary.month" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_giveDate" name="salary.giveDate" />
		...
		<div>
			...
			<span class="inputControl">
				<textarea id="salary_salaryMemo" name="salary.salaryMemo" rows="6" cols="80"></textarea>
