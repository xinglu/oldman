		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>RoomType/frontlist">房间类型列表</a></li>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="roomTypeAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="roomType_typeName" class="col-md-2 text-right">房间类型名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="roomType_typeName" name="roomType.typeName" class="form-control" placeholder="请输入房间类型名称">
							 </div>
						  </div>
				          <div class="form-group">
...
var basePath = "<%=basePath%>";
	...
	function ajaxRoomTypeAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "RoomType/add",
			dataType : "json" , 
			data: new FormData($("#roomTypeAddForm")[0]),
			success : function(obj) {
				if(obj.success){ 
					alert("保存成功！");
					$("#roomTypeAddForm").find("input").val("");
					$("#roomTypeAddForm").find("textarea").val("");
				} else {
					alert(obj.message);
				}
			},
