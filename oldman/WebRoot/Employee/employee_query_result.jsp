...
<div id="employee_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="employeeQueryForm" method="post">
			用户名：<input type="text" class="textbox" id="employeeNo" name="employeeNo" style="width:110px" />
			所在部门：<input class="textbox" type="text" id="departmentObj_departmentId_query" name="departmentObj.departmentId" style="width: auto"/>
