    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>OldMan/frontlist">老人</a></li>
                <li><a href="<%=basePath %>RoomType/frontlist">房间类型</a></li>
                <li><a href="<%=basePath %>Room/frontlist">房间</a></li>
                <li><a href="<%=basePath %>RoomOrder/frontlist">订单</a></li>
                <li><a href="<%=basePath %>Nurse/frontlist">老人看护</a></li>
                <li><a href="<%=basePath %>Reception/frontlist">接待</a></li>
                <li><a href="<%=basePath %>Department/frontlist">部门</a></li>
