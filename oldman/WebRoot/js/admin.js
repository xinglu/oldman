		       ...
		       text: "老人管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "OldMan/oldMan_add.jsp"
			    	   	},
			    		{
			    	   		text: "老人管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "OldMan/oldMan_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "房间类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "RoomType/roomType_add.jsp"
			    	   	},
			    		{
			    	   		text: "房间类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "RoomType/roomType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "房间管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Room/room_add.jsp"
			    	   	},
			    		{
			    	   		text: "房间管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Room/room_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "订单管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "RoomOrder/roomOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "订单管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "RoomOrder/roomOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "老人看护管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Nurse/nurse_add.jsp"
			    	   	},
			    		{
			    	   		text: "老人看护管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Nurse/nurse_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "接待管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Reception/reception_add.jsp"
			    	   	},
			    		{
			    	   		text: "接待管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Reception/reception_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "部门管理",
